...
[nhcustom](https://github.com/Fedora31/no-hats-bgum/programs), an EXPERIMENTAL command-line program whose purpose is to modify the no-hats-mod, is now available for Windows and Linux. Contact me if you encounter problems about it.
